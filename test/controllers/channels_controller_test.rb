...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { title: @channel.title, user_id: @channel.user_id } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { title: @channel.title, user_id: @channel.user_id } }
